      ...
      <div className="rounded-2xl border border-red-200 dark:border-red-800 bg-red-50 dark:bg-red-900/20 p-6 space-y-4">
        ...
        {/route|destination|postal/i.test(error) && (
          <p className="text-xs text-red-600 dark:text-red-400">
            💡 <strong>Hint:</strong> No shipping route has been configured for this destination.
            Ask an admin to add a route from your origin warehouse to this postal code.
          </p>
        )}
        {/carrier|quote/i.test(error) && (
          <p className="text-xs text-red-600 dark:text-red-400">
            💡 <strong>Hint:</strong> No carriers are available for this route or weight.
            Try adjusting shipment details or check carrier configurations.
          </p>
        )}
        {/warehouse/i.test(error) && (
          <p className="text-xs text-red-600 dark:text-red-400">
            💡 <strong>Hint:</strong> The selected warehouse could not be found. Please choose a valid origin warehouse.
          </p>
        )}
